...
filepath = '/media/simran/247656b5-4d6c-4431-8460-8f0eddaf083f/Plant-Leaf-Disease-Prediction/model.h5'
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join('/media/simran/247656b5-4d6c-4431-8460-8f0eddaf083f/Plant-Leaf-Disease-Prediction/static/upload', filename)
        file.save(file_path)
